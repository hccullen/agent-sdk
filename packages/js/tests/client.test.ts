...
import type { CortiClientOptions } from "../src/client.js";
    ...
    agentic: {
      agents: {
        ...
        list: vi.fn().mockResolvedValue({
          response: { agents: [], nextPageToken: null },
          data: [],
        }),
        ...
        getCardUrl: vi
          .fn()
          .mockResolvedValue(
            new URL("https://api.dev-weu.corti.app/v2/card.json"),
          ),
        sendMessage: vi.fn().mockResolvedValue({}),
        streamMessage: vi.fn().mockResolvedValue((async function* () {})()),
        tasks: {
          list: vi.fn().mockResolvedValue({
            response: { tasks: [], nextPageToken: null },
          }),
          get: vi.fn().mockResolvedValue({}),
      ...
      contexts: {
        list: vi.fn().mockResolvedValue({
          response: { contexts: [], nextPageToken: null },
        }),
        get: vi.fn().mockResolvedValue({}),
        delete: vi.fn().mockResolvedValue(undefined),
      ...
      registry: {
        connectors: {
          list: vi.fn().mockResolvedValue({
            response: { connectors: [], nextPageToken: null },
          }),
          get: vi.fn().mockResolvedValue({}),
        },
      },
...
describe("CortiClient", () => {
  ...
  describe("resource delegation", () => {
    it("contexts.list delegates and unwraps .response", async () => {
      ...
      expect(mockSdk.agentic.contexts.list).toHaveBeenCalledWith(
        undefined,
        undefined,
      );
    ...
    it("contexts.get with historyLength passes { historyLength } as 2nd arg", async () => {
      ...
      expect(mockSdk.agentic.contexts.get).toHaveBeenCalledWith(
        "ctx.1",
        { historyLength: 5 },
        undefined,
      );
    ...
    it("contexts.getTrace delegates and unwraps .response", async () => {
      ...
      expect(mockSdk.agentic.contexts.trace).toHaveBeenCalledWith(
        "ctx.1",
        { pageSize: 10 },
        undefined,
      );
    ...
    it("contexts.listTasks delegates and unwraps .response", async () => {
      ...
      expect(mockSdk.agentic.contexts.tasks.list).toHaveBeenCalledWith(
        "ctx.1",
        { pageSize: 5 },
        undefined,
      );
    ...
    it("connectors.create delegates with (agentId, body, opts)", async () => {
      ...
      expect(mockSdk.agentic.agents.connectors.create).toHaveBeenCalledWith(
        "agt.1",
        body,
        undefined,
      );
    ...
    it("registry.list delegates and unwraps .response", async () => {
      ...
      expect(mockSdk.agentic.registry.connectors.list).toHaveBeenCalledWith(
        { pageSize: 5 },
        undefined,
      );
    ...
    it("feedback.create delegates with (contextId, taskId, body, opts)", async () => {
      ...
      expect(
        mockSdk.agentic.contexts.tasks.feedback.create,
      ).toHaveBeenCalledWith("ctx.1", "task.1", { rating: 1 }, undefined);
    });
    ...
    it("sendMessage delegates with (agentId, body, opts)", async () => {
      ...
      expect(mockSdk.agentic.agents.sendMessage).toHaveBeenCalledWith(
        "agt.1",
        body,
        undefined,
      );
    ...
    it("listTasks delegates and unwraps .response", async () => {
      ...
      expect(mockSdk.agentic.agents.tasks.list).toHaveBeenCalledWith(
        "agt.1",
        { pageSize: 5 },
        undefined,
      );
    ...
    it("subscribe delegates to agents.tasks.subscribe", async () => {
      ...
      expect(mockSdk.agentic.agents.tasks.subscribe).toHaveBeenCalledWith(
        "agt.1",
        "task.1",
        undefined,
      );
    ...
    it("getTask delegates to agents.tasks.get with undefined historyLength", async () => {
      ...
      expect(mockSdk.agentic.agents.tasks.get).toHaveBeenCalledWith(
        "agt.1",
        "task.1",
        undefined,
        undefined,
    ...
    it("cancelTask delegates to agents.tasks.cancel", async () => {
      ...
      expect(mockSdk.agentic.agents.tasks.cancel).toHaveBeenCalledWith(
        "agt.1",
        "task.1",
        undefined,
      );
    ...
    it("connectors.list delegates with (agentId, opts)", async () => {
      ...
      expect(mockSdk.agentic.agents.connectors.list).toHaveBeenCalledWith(
        "agt.1",
        undefined,
      );
      expect(result).toEqual([]);
    ...
    it("connectors.get delegates with (agentId, connectorId, opts)", async () => {
      ...
      expect(mockSdk.agentic.agents.connectors.get).toHaveBeenCalledWith(
        "agt.1",
        "con.1",
        undefined,
      );
    ...
    it("connectors.update delegates with (agentId, connectorId, body, opts)", async () => {
      ...
      expect(mockSdk.agentic.agents.connectors.update).toHaveBeenCalledWith(
        "agt.1",
        "con.1",
        body,
        undefined,
    ...
    it("connectors.delete delegates with (agentId, connectorId, opts)", async () => {
      ...
      expect(mockSdk.agentic.agents.connectors.delete).toHaveBeenCalledWith(
        "agt.1",
        "con.1",
        undefined,
      );
    ...
    it("contexts.getArtifact delegates with (contextId, taskId, artifactId, opts)", async () => {
      ...
      expect(mockSdk.agentic.contexts.tasks.artifacts.get).toHaveBeenCalledWith(
        "ctx.1",
        "task.1",
        "art.1",
        undefined,
    ...
    it("feedback.list delegates with (contextId, taskId, opts)", async () => {
      ...
      expect(mockSdk.agentic.contexts.tasks.feedback.list).toHaveBeenCalledWith(
        "ctx.1",
        "task.1",
        undefined,
      );
    ...
    it("feedback.delete delegates with (contextId, taskId, feedbackId, opts)", async () => {
      ...
      expect(
        mockSdk.agentic.contexts.tasks.feedback.delete,
      ).toHaveBeenCalledWith("ctx.1", "task.1", "fb.1", undefined);
    });

    it("usage.get delegates with (agentId, params, opts)", async () => {
      const { client, mockSdk } = makeMockClient();
      await client.usage.get("agt.1", { granularity: "day" });
      expect(mockSdk.agentic.agents.usage).toHaveBeenCalledWith(
        "agt.1",
        { granularity: "day" },
        undefined,
      );
    ...
    it("registry.get delegates with (connectorId, opts)", async () => {
      ...
      expect(mockSdk.agentic.registry.connectors.get).toHaveBeenCalledWith(
        "reg.1",
        undefined,
      );
    });
    ...
    it("agentCard.get delegates to agents.card", async () => {
      ...
      expect(mockSdk.agentic.agents.card).toHaveBeenCalledWith(
        "agt.1",
        undefined,
      );
    });
